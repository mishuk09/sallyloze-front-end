...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get('https://sneakers-backend-2.onrender.com/dashboard', {
                    headers: {
    ...
    const handleSave = async () => {
        ...
        try {
            await axios.put(
                'https://sneakers-backend-2.onrender.com/update-profile',
                {
    ...
    return (
        <div className="container collection pb-10">
            <div className="text-center pt-6 pb-4 lg:pt-10">
                <a href='/' className=" text-center lg:text-start text-sm lg:text-base pl-4">Home / New</a>
